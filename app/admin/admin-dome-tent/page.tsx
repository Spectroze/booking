    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 p-2 sm:p-4 md:p-8">
                  ...
                  className={`relative overflow-hidden min-h-[100px] sm:min-h-[140px] aspect-square border-2 rounded-xl p-1.5 sm:p-2.5 transition-all hover:shadow-lg ${
                    day
                      ? (() => {
                          ...
                          // Pending requests — amber (green = approved in Booked view)
      ...
      {showModal && showRejectModal && selectedBooking && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="reject-modal-title-dome"
        >
          <button
            type="button"
            className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm transition-opacity"
          ...
          <div className="relative w-full max-w-md overflow-hidden rounded-2xl shadow-2xl ring-1 ring-red-200/50 dark:ring-red-900/50 bg-white dark:bg-gray-900">
            <div className="bg-gradient-to-r from-red-600 via-rose-600 to-red-700 px-6 py-5 text-white">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 id="reject-modal-title-dome" className="text-lg font-bold leading-tight">
                    {rejectModalMode === 'cancelConfirmed'
            ...
            <div className="p-6 space-y-4">
              <div>
                <label htmlFor="reject-reason-dome" className="block text-sm font-semibold text-gray-800 dark:text-gray-200 mb-2">
                  {rejectModalMode === 'cancelConfirmed'
