  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 p-2 sm:p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2 flex items-center gap-3">
                  ...
                  {viewMode === 'calendar' ? 'Booking Calendar' : viewMode === 'booked' ? 'Booked Calendar' : 'Booking History'}
                </h1>
                {viewMode === 'calendar' && (
                  <p className="text-blue-100 text-sm sm:text-base mt-1">
                    {monthNames[currentDate.getMonth()]} {currentDate.getFullYear()} - Pending Appointments
                  </p>
                )}
                {viewMode === 'booked' && (
                  <p className="text-blue-100 text-sm sm:text-base mt-1">
                    All confirmed bookings and accepted appointments
                  </p>
                )}
                {viewMode === 'history' && (
                  <p className="text-blue-100 text-sm sm:text-base mt-1">
        ...
        {/* Booked Calendar View - Shows Confirmed Bookings in Table Format */}
        {viewMode === 'booked' && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-100 dark:border-gray-700">
                ...
                <div className="hidden md:block overflow-x-auto rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                  <div className="overflow-hidden rounded-2xl">
                    <table className="w-full">
                      <thead>
                        <tr className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 dark:from-green-600 dark:via-emerald-600 dark:to-teal-600">
                          <th className="text-left py-5 px-6 font-extrabold text-white text-sm uppercase tracking-wider flex items-center gap-2">
                      ...
                      <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                        {confirmedBookings.map((booking, index) => (
                          <tr
                            ...
                            } hover:bg-gradient-to-r hover:from-green-50 hover:via-emerald-50 hover:to-teal-50 dark:hover:from-gray-700/70 dark:hover:via-gray-700/70 dark:hover:to-gray-700/70 hover:shadow-lg hover:scale-[1.01]`}
                          >
                            <td className="py-5 px-6 text-gray-900 dark:text-white font-semibold">
                              <div className="flex items-center gap-3">
                                <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 flex items-center justify-center shadow-sm">
                            ...
                            <td className="py-5 px-6 text-gray-900 dark:text-white">
                              <div className="flex items-center gap-2">
                                <div className="flex-shrink-0 w-8 h-8 rounded-md bg-green-100 dark:bg-green-900/30 flex items-center justify-center shadow-sm">
                            ...
                            <td className="py-5 px-6 text-gray-900 dark:text-white capitalize">
                              <span className="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 text-emerald-800 dark:text-emerald-300 shadow-sm">
                            ...
                            <td className="py-5 px-6">
                              <button
                                onClick={() => openBookingModal(booking)}
                                className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl text-sm font-bold transition-all shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
                              >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 border border-gray-100 dark:border-gray-700">
            {historyBookings.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">
                  Accepted and rejected bookings will appear here
                </p>
              </div>
            ) : (
              <>
